                            ...
                            <div class="card-header bg-primary border-0">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-9">
                                        <h1 class="text-white text-capitalize lh-base fw-lighter">{{ __('auth_register_title') }}</h1>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="p-2">
                                    <form class="needs-validation" novalidate method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                                        ...
                                        <div class="mt-4 col-md-12">
                                            <button class="btn btn-primary w-100" type="submit">{{ __('auth_register') }}</button>
                                        </div>
